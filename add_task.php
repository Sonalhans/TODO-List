...
<body class="bg-gray-50">
    <h1 class="text-center text-4xl font-serif mt-5">Add New Task </h1>
    <form method="post" action="">
        ...
        <div class="mx-60">
            ...
            <div class="mt-5">
                ...
                <button type="submit" class="rounded-full bg-red-400 px-4 py-2.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Add Task</button>
            </div>
