...
<body class="bg-pink-100">
    <h1 class="bg-red-200  p-5 text-center font-serif text-4xl ">To-Do List</h1>
    <div class="my-10 mx-24">
        <a href="add_task.php" type="button" class="ml-40 mt-5 rounded-md bg-white-300 px-3.5 py-2.5 my-20 text-sm bg-gray-300 font-semibold text-black shadow-sm hover:bg-white/20">Add New Task +</a>
    </div>
    <div class=" bg-white-300 mx-60">
        <table>
            <tr>
                ...
                <tbody class="divide-y divide-gray-200 ">
                    <tr>
                        ...
                        <td class="px-3 py-3.5 text-left text-md font-semibold text-gray-900">
                            <a type="button" class=" mt-5 rounded-md bg-indigo-500 px-3.5  text-sm bg-gray-300 font-semibold text-black shadow-sm hover:bg-indigo-200" href=" edit_task.php?id=<?php echo $row['id']; ?>">Edit</a>
                            <a type="button" class=" mt-5 rounded-md bg-red-600 px-3.5  text-sm bg-gray-300 font-semibold text-black shadow-sm hover:bg-red-500" href="delete_task.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?')">Delete</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
        </table>
