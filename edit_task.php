...
<body class="bg-violet-50">
    ...
    <form method="post" action="">
        <div class="mx-60 p-5 bg-violet-100 block shadow-lg rounded-xl ">
            ...
            <button type="submit" class="my-3 rounded-full bg-violet-300 px-4 py-2.5 text-sm font-semibold text-violet-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Update Task</button>
